...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "user1@gmail.com", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "user2", "user2@gmail.com", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "user3", "user3@gmail.com", "ROLE_USER");
    ...
    public void create_user_with_null_username() {
        sut.create(null, USER_3.getPassword(), "ROLE_USER", USER_3.getUserEmail());
    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.create(USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", USER_3.getUserEmail());
    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.create(USER_3.getUsername(), null, "ROLE_USER", USER_3.getUserEmail());
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User(-1, "new", "user", "test@email.com", "ROLE_USER");

        boolean userWasCreated = sut.create(newUser.getUsername(), newUser.getPassword(), newUser.getUserEmail(), "ROLE_USER");
